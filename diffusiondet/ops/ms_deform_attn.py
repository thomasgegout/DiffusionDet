...
# NOTE: MultiScaleDeformableAttnFunction class removed - it required detrex CUDA ops
# We now use the pure PyTorch implementation only (multi_scale_deformable_attn_pytorch)
...
class MultiScaleDeformableAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        # Use the pure PyTorch implementation (no CUDA ops required)
