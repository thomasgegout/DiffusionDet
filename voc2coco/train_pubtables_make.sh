...
python voc2coco/voc2coco.py \
    --ann_paths_list ~/.cache/huggingface/hub/datasets--bsmock--pubtables-1m/snapshots/35b1c097807e0b07ec5313879b85956b7b3890db/PubTables-1M-Structure/train_filelist.txt \
